...
export default function InfoPatient() {
  ...
  return (
    <Container className="mt-4">
      <h1>
        Ficha do paciente <span className={style.span}>{paciente.nome}</span>
      </h1>
      <hr></hr>
            ...
            <Card style={{ width: "30em" }}>
              <Card.Body>
                {paciente.status === "sem_diagnostico" ? (
                  <Card.Img
                    variant="top"
                    src={fotoBaseUrlImage + paciente.foto}
                    className={style.sem_diagnostico}
                    style={{
                      scale: "95%",
                    }}
                  />
                  ...
                  <Card.Img
                    variant="top"
                    src={fotoBaseUrlImage + paciente.foto}
                    className={style.sintomas_insuficientes}
                    style={{
                      scale: "95%",
                    }}
                  />
                  ...
                  <Card.Img
                    variant="top"
                    src={fotoBaseUrlImage + paciente.foto}
                    className={style.potencial_infectado}
                    style={{
                      scale: "95%",
                    }}
                  />
                  ...
                  <Card.Img
                    variant="top"
                    src={fotoBaseUrlImage + paciente.foto}
                    className={style.possivel_infectado}
                    style={{
                      scale: "95%",
                    }}
                  />
                  ...
                  <table className={[style.table, "table"].join(" ")}>
                    ...
                    <tbody className="table-group-divider">
                      <tr key={paciente.id}>
                        ...
                        <td>
                          {sintomas.pa_sistolica} x {sintomas.pa_diastolica}
                        </td>
                        {paciente.status === "sem_diagnostico" ? (
                          <td className="alertTable">
                            <Alert
