...
function PatientDiagnosis() {
  ...
  const handleEnviarDadosSaude = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const quantidadeSintomas = Object.values(sintomas).filter(
      (value) => value
    ).length;
    let novoStatus = "";
    ...
    return (
      <>
        <div className="container">
          ...
          >
            <p>
              Você não pode realizar outro diagnóstico!. Podera editar o diagnóstico em editar
            </p>
          </Alert>
        </div>
          <Link to={`/`}>
  ...
  return (
    <Container className="mt-4">
      <h1>
        Análise Diagnóstica de{" "}
        <span className={style.span}>{paciente.nome}</span>
      </h1>
      <hr></hr>
        ...
        >
          <Card.Body>
            ...
            <div className="row">
              ...
              >
                <img
                  src={`http://localhost:8000/api/${paciente.foto}`}
                  alt=""
                  style={{
                    width: "450px",
                    borderRadius: "5%",
              ...
              <Card.Body>
                <div className={style.cardTitle}>
                  <div>
                    ...
                    {/* <Card.Subtitle className="mb-2 text-muted">
                        Pode-se não ter sintomas no começo.
                  </Card.Subtitle> */}
                  </div>
                  <div>
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setDadosSaude({
                                ...dadosSaude,
                                pressaoSistolica: e.target.value,
                              })
                            }
                            required
                          />
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setDadosSaude({
                                ...dadosSaude,
                                pressaoDiastolica: e.target.value,
                              })
                            }
                            required
                          />
                        ...
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            onChange={(e) =>
                              setDadosSaude({
                                ...dadosSaude,
                                frequenciaRespiratoria: e.target.value,
                              })
                            }
                            required
                          />
                      ...
                      <div className="col-md-6">
                        ...
                        <Form.Check
                          ...
                          onChange={(e) =>
                            setSintomas({
                              ...sintomas,
                              narizentupido: e.target.checked,
                            })
                          }
                        />
                        <Form.Check
                        ...
                        <Form.Check
                          ...
                          onChange={(e) =>
                            setSintomas({
                              ...sintomas,
                              dificuldaderespirar: e.target.checked,
                            })
                          }
                        />
                        <Form.Check
                        ...
                        <Form.Check
                          ...
                          onChange={(e) =>
                            setSintomas({
                              ...sintomas,
                              dificuldadelocomocao: e.target.checked,
                            })
                          }
                        />
                        <Form.Check
